...
export type HostChannel = 'network' | 'storage' | 'secrets' | 'model' | 'svg' | 'models' | 'media' | 'subworker' | 'python' | 'attachments';

export const HOST_CHANNELS: readonly HostChannel[] = ['network', 'storage', 'secrets', 'model', 'svg', 'models', 'media', 'subworker', 'python', 'attachments'];
