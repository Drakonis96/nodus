...
const COPY: Record<ToolkitDialogKey, UiTranslations> = {
  ...
  'zh-TW': '新增用於OCR的PDF或圖片',
  ko: "OCR용 PDF 또는 이미지 추가",
  ja: "OCR 用の PDF または画像を追加する", },
  ...
  'zh-TW': '匯入PDF或簡報',
  ko: "PDF 또는 프리젠테이션 가져오기",
  ja: "PDF またはプレゼンテーションをインポートする", },
  ...
  'zh-TW': '從PowerPoint匯入備註',
  ko: "PowerPoint에서 노트 가져오기",
  ja: "PowerPoint からメモをインポートする", },
  ...
  'zh-TW': '選擇用於Nodus Protect的文件',
  ko: "Nodus Protect에 대한 문서 선택",
  ja: "Nodus Protect のドキュメントを選択してください", },
