...
import { prosopographyApi } from './preload/prosopography';
import { testimoniesApi } from './preload/testimonies';
import { toolkitApi } from './preload/toolkit';
...
import { worldbuildingApi } from './preload/worldbuilding';
import { platformApi } from './preload/platform';
import { recordsApi } from './preload/records';
import { academicApi } from './preload/academic';
...
//
// Domain slices live in electron/preload/ and are spread in below; `NodusApi` on
// this object is what makes a method lost during a move a typecheck failure
