...
export const teachingApi: TeachingApi = {
  ...
  getAttendanceSheet: (groupId, from, to) => ipcRenderer.invoke('teaching:attendance:sheet', groupId, from, to),
  setAttendance: (input) => ipcRenderer.invoke('teaching:attendance:set', input),
  clearAttendance: (studentId, date) => ipcRenderer.invoke('teaching:attendance:clear', studentId, date).then(() => undefined),
  fillAttendanceDay: (groupId, date, status) => ipcRenderer.invoke('teaching:attendance:fillDay', groupId, date, status),
  setAttendanceHoliday: (groupIds, date, label) => ipcRenderer.invoke('teaching:attendance:holiday:set', groupIds, date, label).then(() => undefined),
  clearAttendanceHoliday: (groupIds, date) => ipcRenderer.invoke('teaching:attendance:holiday:clear', groupIds, date).then(() => undefined),
  attendanceHolidayGroups: (date) => ipcRenderer.invoke('teaching:attendance:holiday:groups', date),
  getAttendanceExportData: (request) => ipcRenderer.invoke('teaching:attendance:exportData', request),
  exportAttendance: (format, tables, baseName) => ipcRenderer.invoke('teaching:attendance:export', format, tables, baseName),
