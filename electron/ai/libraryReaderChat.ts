...
const LIBRARY_READER_CONTEXT_COPY: Record<PromptLanguage, LibraryReaderContextCopy> = {
  ...
  'zh-Hans': { truncated: '[... 中间内容因上下文限制已省略 ...]', cleanMarkdown: '干净的 Markdown', cleanVersionContext: '干净版本上下文', documentUnavailable: '文档已不再可用。', unreadableFile: '此文件不包含可供聊天读取的文本。', unreadableSource: '所选来源不包含可供聊天读取的文本。', questionRequired: '发送前请输入问题。' },
  'zh-Hant': { truncated: '[... 中間內容因上下文限制已省略 ...]', cleanMarkdown: '乾淨的 Markdown', cleanVersionContext: '乾淨版本脈絡', documentUnavailable: '文件已不再可用。', unreadableFile: '此檔案不包含可供聊天讀取的文字。', unreadableSource: '所選來源不包含可供聊天讀取的文字。', questionRequired: '傳送前請輸入問題。' },
  vi: { truncated: '[... nội dung ở giữa đã được lược bỏ do giới hạn ngữ cảnh ...]', cleanMarkdown: 'Markdown sạch', cleanVersionContext: 'ngữ cảnh của phiên bản sạch', documentUnavailable: 'Tài liệu không còn khả dụng nữa.', unreadableFile: 'Tệp này không chứa văn bản đọc được cho cuộc trò chuyện.', unreadableSource: 'Nguồn đã chọn không chứa văn bản đọc được cho cuộc trò chuyện.', questionRequired: 'Hãy nhập câu hỏi trước khi gửi.' },
  ja: { truncated: '[... コンテキスト上限のため中間部分を省略 ...]', cleanMarkdown: 'クリーンな Markdown', cleanVersionContext: 'クリーン版のコンテキスト', documentUnavailable: 'ドキュメントは利用できなくなりました。', unreadableFile: 'このファイルにはチャットで読めるテキストが含まれていません。', unreadableSource: '選択したソースにはチャットで読めるテキストが含まれていません。', questionRequired: '送信する前に質問を入力してください。' },
  ru: { truncated: '[... середина содержимого опущена из-за ограничения контекста ...]', cleanMarkdown: 'Чистый Markdown', cleanVersionContext: 'контекст очищенной версии', documentUnavailable: 'Документ больше недоступен.', unreadableFile: 'Этот файл не содержит текста, пригодного для чтения в чате.', unreadableSource: 'Выбранный источник не содержит текста, пригодного для чтения в чате.', questionRequired: 'Введите вопрос перед отправкой.' },
  uk: { truncated: '[... середину вмісту пропущено через обмеження контексту ...]', cleanMarkdown: 'Чистий Markdown', cleanVersionContext: 'контекст очищеної версії', documentUnavailable: 'Документ більше недоступний.', unreadableFile: 'Цей файл не містить тексту, придатного для читання в чаті.', unreadableSource: 'Вибране джерело не містить тексту, придатного для читання в чаті.', questionRequired: 'Введіть запитання перед надсиланням.' },
  ko: { truncated: '[... 컨텍스트 한도로 중간 내용을 생략했습니다 ...]', cleanMarkdown: '정리된 Markdown', cleanVersionContext: '정리된 버전 컨텍스트', documentUnavailable: '문서를 더 이상 사용할 수 없습니다.', unreadableFile: '이 파일에는 채팅에서 읽을 수 있는 텍스트가 없습니다.', unreadableSource: '선택한 소스에는 채팅에서 읽을 수 있는 텍스트가 없습니다.', questionRequired: '보내기 전에 질문을 입력하십시오.' },
};
