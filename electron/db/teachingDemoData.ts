...
type DemoLocale = 'es' | 'en' | 'zh-CN' | 'zh-TW';
type Localized = { es: string; en: string; 'zh-CN': string; 'zh-TW': string };
...
const PLAN_TREE: PlanNode[] = [
  ...
  'zh-TW': '第三單元考試', }, kind: 'activity', weight: 60, weightAlt: 60, aggregation: 'weighted', entryMode: 'numeric', maxPoints: 10, isMandatory: 0, minToAverage: null, sourceExamId: ID.exam },
      { id: 'demo-teaching-item-maps', name: { es: 'Prueba de mapas', en: 'Map test', 'zh-CN': '地图测验' ,
  'zh-TW': '地圖測驗', }, kind: 'activity', weight: 40, weightAlt: 40, aggregation: 'weighted', entryMode: 'numeric', maxPoints: 10, isMandatory: 0, minToAverage: null },
    ],
  },
  {
  ...
  'zh-TW': '引導式文本評析', }, kind: 'activity', weight: 100, weightAlt: 100, aggregation: 'weighted', entryMode: 'rubric', maxPoints: 10, isMandatory: 0, minToAverage: null, sourceRubricId: ID.rubric },
    ],
  },
  {
  ...
  'zh-TW': '課堂筆記本', }, kind: 'activity', weight: 50, weightAlt: 0, aggregation: 'weighted', entryMode: 'numeric', maxPoints: 10, isMandatory: 0, minToAverage: null },
      { id: 'demo-teaching-item-participation', name: { es: 'Participación argumentada', en: 'Reasoned participation', 'zh-CN': '有论据的课堂参与' ,
  'zh-TW': '有論據的課堂參與', }, kind: 'activity', weight: 50, weightAlt: 0, aggregation: 'weighted', entryMode: 'numeric', maxPoints: 10, isMandatory: 0, minToAverage: null },
    ],
  },
];
...
export function seedTeachingDemoData(): boolean {
  ...
  'zh-TW': '第 3 課時', }), 'ready', 1, 0, 0, createdAt, updatedAt);
  ...
  'zh-TW': '方法', }), 0, createdAt, updatedAt);
  ...
  'zh-TW': '收束本單元，將所描述的條件與其後果聯絡起來。', },
    ...
    const unitLink = (source: 'material' | 'doc'): string => (source === 'material'
      ? `[${pick({ es: 'Fuente · Informe fabril (1832)', en: 'Source · Factory report (1832)', 'zh-CN': '史料 · 工厂报告（1832）' ,
  'zh-TW': '史料 · 工廠報告（1832）', })}](nodus://study/material/${ID.material})`
      : `[${pick({ es: 'Unidad 3 · guion de sesiones', en: 'Unit 3 · session outline', 'zh-CN': '第三单元 · 课时纲要' ,
  'zh-TW': '第三單元 · 課時綱要', })}](nodus://study/doc/${ID.docPlan})`);
  ...
  'zh-TW': '為初三設計工業革命單元', }), tone: 'academic', language: promptL };
    const unitDraft = {
  ...
  'zh-TW': '初三A班', }), ID.subjectHistory, ID.academicYear, STUDENTS.length, 0, createdAt, updatedAt);
