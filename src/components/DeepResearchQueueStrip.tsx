...
//
// One strip, two lanes. Reports queued in this window and reports queued by an MCP
// client are generated by different code but are the same thing to whoever is
// waiting, so the caller flattens both into `QueueStripItem` and the strip never
// has to know whose progress it is showing.
