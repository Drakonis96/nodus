...
export const PERSON_DOSSIER_SECTION_CLASS =
  'rounded-md border border-neutral-200 bg-neutral-50 p-3 dark:border-neutral-800 dark:bg-neutral-900/40';
...
export const PERSON_DOSSIER_ADD_BUTTON_CLASS =
  'btn btn-ghost h-8 w-8 shrink-0 justify-center border border-neutral-300 p-0 dark:border-neutral-700';
...
export const PERSON_DOSSIER_ACTION_BUTTON_CLASS =
  'btn btn-ghost h-auto min-h-9 min-w-44 shrink-0 justify-center gap-1.5 whitespace-normal border border-neutral-300 px-4 py-2 text-center text-[11px] leading-snug dark:border-neutral-700';
