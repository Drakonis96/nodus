...
function AuthorDossier({ dossier, onBack, privateSynthesis }: { dossier: AdvancedAuthorDossier; onBack: () => void; privateSynthesis?: ReactNode }) {
...
export function AuthorsServerView({ spaceId, renderPrivateSynthesis }: { spaceId: string; renderPrivateSynthesis?: (dossier: AdvancedAuthorDossier) => ReactNode }) {
  const [query, setQuery] = useState('');
