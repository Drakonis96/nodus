...
export function StudyHome({ onNavigate, onOpenDocument, showDemoOffer = true, demoBusy = false, onLoadDemo }: { onNavigate: (view: View) => void; onOpenDocument?: (id: string) => void; showDemoOffer?: boolean; demoBusy?: boolean; onLoadDemo?: () => void }) {
  ...
  return (
    <div className="study-home h-full overflow-y-auto p-6">
      <div className="mx-auto max-w-5xl space-y-6">
        <HomeIntroCard
          eyebrow={t('Vault de estudio')}
          title={t('Tu espacio de aprendizaje')}
          description={t('Organiza materiales y apuntes, crea evaluaciones y consulta tus preguntas desde un espacio local y privado.')}
          icon="graduation"
        />

        {showDemoOffer && onLoadDemo && (
          <DemoOfferCard variant="study" demoBusy={demoBusy} onLoadStudyDemo={onLoadDemo} />
        )}
