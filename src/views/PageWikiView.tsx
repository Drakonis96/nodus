  ...
  return (
    <div className="flex h-full min-h-0 min-w-0 flex-col overflow-hidden bg-white text-neutral-900 dark:bg-neutral-950 dark:text-neutral-100" data-testid="page-wiki-view">
      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 lg:grid-cols-[230px_minmax(0,1fr)] xl:grid-cols-[240px_minmax(0,1fr)_250px]">
        <aside className={`${mobilePanel === 'tree' ? 'flex' : 'hidden'} min-h-0 min-w-0 flex-col border-r border-neutral-200 bg-transparent dark:border-neutral-800 lg:flex`} aria-label={t('Árbol de páginas')}>
        ...
        <aside className={`${mobilePanel === 'context' ? 'block' : 'hidden'} min-h-0 min-w-0 overflow-x-hidden overflow-y-auto border-l border-neutral-200 bg-transparent p-3 dark:border-neutral-800 lg:col-start-2 lg:row-start-1 xl:col-start-3 xl:block`} aria-label={t('Contexto de página')}>
