export const RESEARCH_NOTEBOOK_TRANSLATIONS = {
  "en": {
    ...
    "Los documentos que necesiten OCR se omitirán por ahora.": "Documents requiring OCR will be skipped for now.",
  ...
  "fr": {
    ...
    "Los documentos que necesiten OCR se omitirán por ahora.": "Les documents nécessitant un OCR seront ignorés pour le moment.",
  ...
  "de": {
    ...
    "Los documentos que necesiten OCR se omitirán por ahora.": "Dokumente, die OCR benötigen, werden vorerst übersprungen.",
  ...
  "it": {
    ...
    "Los documentos que necesiten OCR se omitirán por ahora.": "I documenti che richiedono OCR saranno saltati per ora.",
  ...
  "pt": {
    ...
    "Los documentos que necesiten OCR se omitirán por ahora.": "Os documentos que necessitem de OCR serão ignorados por agora.",
  ...
  "pt-BR": {
    ...
    "Los documentos que necesiten OCR se omitirán por ahora.": "Os documentos que precisarem de OCR serão ignorados por enquanto.",
  ...
  "tr": {
    ...
    "Los documentos que necesiten OCR se omitirán por ahora.": "OCR gerektiren belgeler şimdilik atlanacak.",
  ...
  "zh-CN": {
    ...
    "Los documentos que necesiten OCR se omitirán por ahora.": "暂时跳过需要 OCR 的文档。",
  ...
  "zh-TW": {
    ...
    "Los documentos que necesiten OCR se omitirán por ahora.": "暫時略過需要 OCR 的文件。",
  ...
  "ja": {
    ...
    "Los documentos que necesiten OCR se omitirán por ahora.": "OCR が必要な文書は当面スキップします。",
  ...
  "ko": {
    ...
    "Los documentos que necesiten OCR se omitirán por ahora.": "OCR이 필요한 문서는 당분간 건너뜁니다.",
