...
import { ZH_CN as LEGACY_ZH_CN } from "./i18n.zh-CN";
...
const ZH_CN: Record<string, string> = completeCompass({
  "Nodus Compass": "Nodus Compass",
  "Descubre literatura académica en fuentes abiertas.":
    "在开放来源中发现学术文献。",
  "Buscar literatura": "搜索文献",
  Buscar: "搜索",
  "Limpiar resultados": "清除结果",
  "Interpretar con IA": "使用 AI 解读",
  Filtros: "筛选",
  ...
  Disciplina: "学科",
  Proveedor: "提供商",
  "Solo acceso abierto": "仅开放获取",
  Relevancia: "相关度",
  Fecha: "日期",
  Citas: "引用",
  "Cargar más": "加载更多",
  "Seleccionar página": "选择页面",
  "Importar selección": "导入所选内容",
  Guardado: "已保存",
  Guardar: "保存",
  Descartar: "忽略",
  Restaurar: "恢复",
  ...
  "Abrir fuente": "打开来源",
  "Sin resultados": "无结果",
  "Prueba otra consulta o quita algún filtro.": "请尝试其他查询或移除某个筛选条件。",
  "Escribe una consulta para empezar.": "输入查询即可开始。",
  "Buscando…": "搜索中…",
  "Interpretando consulta…": "正在解读查询…",
  "Resultados parciales": "部分结果",
  "Búsqueda completa": "搜索完成",
  "Búsqueda cancelada": "搜索已取消",
  "Error en la búsqueda": "搜索错误",
  Historial: "历史记录",
  "Borrar historial": "清除历史记录",
  "No hay búsquedas todavía.": "暂无搜索记录。",
  Proveedores: "提供商",
  Selección: "选择",
  "{n} seleccionados": "已选择 {n} 项",
  "Importando…": "正在导入…",
  "Importación completada": "导入完成",
  "Importación fallida": "导入失败",
  ...
  "Esta consulta se enviará a las fuentes seleccionadas.":
    "此查询将发送到所选的来源。",
  "La interpretación con IA es opcional.": "AI 解读为可选项。",
  Cerrar: "关闭",
  Detalles: "详情",
  Autores: "作者",
  Publicado: "已发表",
  ...
  Ordenar: "排序",
  Borrar: "删除",
  "Por qué se recomienda": "推荐原因",
  "Coincide con los conceptos de la consulta": "与查询中的概念匹配",
  "Coincide con una frase exacta": "与精确短语匹配",
  "Coincide con el autor solicitado": "与所请求的作者匹配",
  "Coincide con el idioma solicitado": "与所请求的语言匹配",
  "Coincide con el tipo de publicación": "与所请求的出版物类型匹配",
  "Coincide con el intervalo de fechas": "与所请求的日期范围匹配",
  "Tiene acceso abierto verificado": "具有已验证的开放获取",
  "Procede de una fuente adecuada para la consulta": "来自适合该查询的索引",
  "Está relacionado por citas": "通过引用相关联",
  "Tiene similitud semántica local": "具有本地语义相似度",
  Artículo: "文章",
  Libro: "图书",
  Capítulo: "章节",
  Tesis: "学位论文",
  Informe: "报告",
  "Conjunto de datos": "数据集",
  Prepublicación: "预印本",
  Otro: "其他",
  "Candidatos guardados": "已保存的候选",
  "Reintentar búsqueda": "重试搜索",
  "Sin conexión": "离线",
  idle: "空闲",
  queued: "已排队",
  searching: "搜索中",
  ...
  "Descubre literatura académica y fuentes primarias abiertas.":
    "发现学术文献与开放原始资料。",
  "Literatura académica": "学术文献",
  "Fuentes primarias": "原始资料",
  "Tipo de fuente": "来源类型",
  "La consulta se envía directamente a los proveedores mostrados; Nodus no usa proxy.":
    "查询会直接发送到所示提供商；Nodus 不使用代理。",
  "El LLM permanece apagado por defecto.": "LLM 默认保持关闭。",
  "Disponible digitalmente": "可数字获取",
  "{n} seleccionados, {hidden} ocultos por filtros":
    "已选择 {n} 项，{hidden} 项被筛选条件隐藏",
  "En cola": "排队中",
  "Límite temporal": "已限流",
  "Presupuesto agotado": "预算已用尽",
  "Error parcial": "部分错误",
  "Archivo abierto verificado": "已验证的开放文件",
  Fotografía: "照片",
  Prensa: "报刊",
  Mapa: "地图",
  Manuscrito: "手稿",
  ...
  "temporarily-disabled": "暂时停用",
  created: "已创建元数据",
  "linked-existing": "已关联到现有条目",
  "metadata-completed": "元数据已完成",
  downloading: "正在下载",
  attached: "已附加",
  "no-file": "无开放文件",
  "skipped-limit": "因限制被跳过",
  "skipped-duplicate": "已存在",
  failed: "失败",
  checking: "正在检查",
}, LEGACY_ZH_CN);
...
export { EN, FR, DE, PT, PT_BR, IT, TR, ZH_CN };
