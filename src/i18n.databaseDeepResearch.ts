...
const catalog = [
  ...
  [
    ...
    "Tablolarınızı net bir soruyla, izlenebilir kaynaklar ve maliyet kontrolüyle araştırın.", "用明确的问题、来源可追溯性和成本控制来研究你的表格。", "用明確的問題、來源可追溯性和成本控制來研究你的表格。", "明確な質問、ソースの追跡可能性、コスト管理を行ってテーブルを調査します。"
  ],
  [
    ...
    "Yalnızca bu vaulttaki verileri kullanır", "仅使用此资料库的数据", "僅使用此資料庫的資料", "このボールトのデータのみを使用します"
  ],
  [
    ...
    "1. Amacı tanımlayın", "1. 定义目标", "1. 定義目標", "1. 目的を定義する"
  ],
  [
    ...
    "Soru, hangi satırların okunacağını ve yanıtın nasıl düzenleneceğini belirler.", "问题决定读取哪些行以及如何组织答案。", "問題決定讀取哪些行以及如何組織答案。", "質問は、どの行が読み取られるか、および回答がどのように構成されているかを示します。"
  ],
  [
    ...
    "Bu veritabanlarıyla neyi keşfetmek, karşılaştırmak veya açıklamak istiyorsunuz?", "你想通过这些数据库发现、比较或解释什么？", "你想通過這些資料庫發現、比較或解釋什麼？", "これらのデータベースを使って何を発見、比較、説明したいですか?"
  ],
  [
    "Bases y vistas",
    "Databases and views",
    ...
    "Database e viste",
    "Veritabanları ve görünümler", "数据库与视图", "資料庫與檢視", "データベースとビュー"
  ],
  [
    "Filtro de filas",
    "Row filter",
  ...
  [
    ...
    "Satırların içinde metin ara…", "在行内搜索文本…", "在行內搜尋文本…", "行内のテキストを検索…"
  ],
  [
    ...
    "Filtre yalnızca çalışma kümesini daraltır; veritabanlarınızı değiştirmez.", "筛选仅缩小工作集；不会修改你的数据库。", "篩選僅縮小工作集；不會修改你的資料庫。", "フィルターはワーキングセットを絞り込むだけです。データベースは変更されません。"
  ],
  [
    ...
    "2. Sütun rollerini ata", "2. 为列分配角色", "2. 為列分配角色", "2. 列の役割を割り当てる"
  ],
  [
    ...
    "Planlayıcının iddiaları, bağlamı ve karşılaştırmayı ayırt etmesine yardım edin.", "帮助规划器区分论断、背景与对照。", "幫助規劃器區分論斷、背景與對照。", "プランナーが主張、文脈、対比を区別できるようにします。"
  ],
  [
    "Afirmaciones",
    "Claims",
  ...
  [
    ...
    "Her satırın desteklediği veya gösterdiği şey", "每行支持或证明了什么", "每行支援或證明了什麼", "各行がサポートまたは実証しているもの"
  ],
  [
    "Contexto",
    "Context",
  ...
  [
    ...
    "Arka plan, tarihler ve kapsam", "背景信息、日期与范围", "背景資訊、日期與範圍", "背景、日付、範囲"
  ],
  [
    "Contraste",
    "Contrast",
  ...
  [
    ...
    "Nüanslandıran veya çelişen sinyaller", "能够限定或反驳的信号", "能夠限定或反駁的訊號", "適格または矛盾するシグナル"
  ],
  [
    "Método",
    "Method",
  ...
  [
    ...
    "Verinin nasıl elde edildiği veya ölçüldüğü", "数据如何获得或测量", "資料如何獲得或測量", "データの取得または測定方法"
  ],
  [
    ...
    "Otomatik algıla", "自动检测", "自動檢測", "自動検出"
  ],
  [
    "3. Preview editable",
    "3. Editable preview",
    ...
    "3. Düzenlenebilir önizleme", "3. 可编辑预览", "3. 可編輯預覽", "3. 編集可能なプレビュー"
  ],
  [
    ...
    "Bütçe harcamadan önce örneği inceleyin ve yapıyı ayarlayın.", "在消耗预算前查看样本并调整结构。", "在消耗預算前檢視樣本並調整結構。", "予算を使う前にサンプルを確認し、構造を調整してください。"
  ],
  [
  ...
  [
    ...
    "Orçamento e modelo",
    "Budget e modello",
    "Bütçe ve model", "预算与模型", "預算與模型", "予算とモデル"
  ],
  [
    ...
    "Sınır, iş kuyruğa alınmadan önce kontrol edilir.", "在将任务加入队列前会检查限额。", "在將任務加入佇列前會檢查限額。", "作業をキューに入れる前に制限がチェックされます。"
  ],
  [
    "Modelo",
    "Model",
  ...
  [
    ...
    "Tahmini maliyet sınırı (USD)", "预估成本限额（USD）", "預估成本限額（USD）", "推定コスト制限 (USD)"
  ],
  [
    "Coste estimado",
    "Estimated cost",
    ...
    "Custo estimado",
    "Costo stimato",
    "Tahmini maliyet", "预估成本", "預估成本", "推定コスト"
  ],
  [
    "Dentro del límite",
    "Within limit",
  ...
  [
    ...
    "Derinliği ayarlayın veya sınırı artırın", "调整深度或提高限额", "調整深度或提高限額", "深さを調整するか、制限を増やします"
  ],
  [
    ...
    "Iniciar pesquisa",
    "Avvia ricerca",
    "Araştırmayı başlat", "开始研究", "開始研究", "研究を始める"
  ],
  [
    ...
    "Yürütme zaman çizelgesi", "执行时间线", "執行時間線", "実行タイムライン"
  ],
  [
    ...
    "Her aşama incelenebilir bir iz bırakır.", "每个阶段都会留下可核查的痕迹。", "每個階段都會留下可核查的痕跡。", "各フェーズはレビュー可能な痕跡を残します。"
  ],
  [
    "Trabajos",
    "Jobs",
  ...
  [
    ...
    "Kuyruk her araştırmanın durumunu, aşamasını ve maliyetini saklar.", "队列会保留每次研究的状态、阶段和成本。", "佇列會保留每次研究的狀態、階段和成本。", "キューは、すべての調査実行のステータス、フェーズ、コストを保持します。"
  ],
  [
    ...
    "Sonuç galerisi", "结果库", "結果庫", "結果ギャラリー"
  ],
  [
    ...
    "Bir raporu okumak ve kaynaklarını incelemek için açın.", "打开报告以阅读并查看其来源。", "開啟報告以閱讀並檢視其來源。", "レポートを開いて読んでソースを確認します。"
  ],
  [
    "Evidencia",
    "Evidence",
  ...
  [
    ...
    "Seçilen ayrıntı", "所选详情", "所選詳情", "選択された詳細"
  ],
  [
    "Fila sin título",
    "Untitled row",
    ...
    "Linha sem título",
    "Riga senza titolo",
    "Başlıksız satır", "无标题行", "無標題行", "無題の行"
  ],
  [
    ...
    "Riga del database",
    "Veritabanı satırı", "数据库行", "資料庫行", "データベース行"
  ],
  [
    ...
    "Veritabanı araştırması", "数据库研究", "資料庫研究", "データベース調査"
  ],
  [
    "Preparando",
    "Preparing",
  ...
  [
    ...
    "Çerçeve ve kapsam", "问题设定与范围", "問題設定與範圍", "枠組みと範囲"
  ],
  [
    ...
    "Araştırmanın hangi soruyu yanıtladığı ve kapsam dışında kalanlar.", "研究回答什么问题，以及哪些不在范围内。", "研究回答什麼問題，以及哪些不在範圍內。", "研究ではどの疑問が解決され、何が範囲外なのか。"
  ],
  [
    ...
    "Padrões principais",
    "Pattern principali",
    "Ana örüntüler", "主要模式", "主要模式", "主なパターン"
  ],
  [
    ...
    "Verilerde hangi ilişkilerin, değişimlerin veya yoğunlaşmaların görüldüğü.", "数据中出现了哪些关系、变化或集中现象。", "資料中出現了哪些關係、變化或集中現象。", "データにどのような関係、変化、集中が現れるか。"
  ],
  [
    ...
    "Karşıtlıklar ve istisnalar", "对照与例外", "對照與例外", "対照と例外"
  ],
  [
    ...
    "Hangi satırların baskın yorumu nüanslandırdığı veya soru doğurduğu.", "哪些行限定了主流解读或提出了疑问。", "哪些行限定了主流解讀或提出了疑問。", "どの行が主な解釈を決定するか、または疑問を引き起こします。"
  ],
  [
    ...
    "Doğrulanabilir sonuçlar", "可验证的结论", "可驗證的結論", "検証可能な結論"
  ],
  [
    ...
    "Nelerin söylenebileceği ve sonrasında neyin incelenmesi gerektiği.", "可以断言什么，以及之后应复查什么。", "可以斷言什麼，以及之後應複查什麼。", "何が主張できるのか、次に何を見直すべきなのか。"
  ],
  [
    ...
    "Araştırmaya başlamadan önce bir amaç yazın.", "在开始研究前写下目标。", "在開始研究前寫下目標。", "研究を始める前に目的を書きましょう。"
  ],
  [
    ...
    "En az bir veritabanı seçin.", "至少选择一个数据库。", "至少選擇一個數據庫。", "少なくとも1つのデータベースを選択します。"
  ],
  [
    ...
    "Bağlam: seçilen veritabanları üzerinde araştırma.", "背景：针对所选数据库的研究。", "背景：針對所選資料庫的研究。", "コンテキスト: 選択したデータベースを調査します。"
  ],
  [
    ...
    "Araştırma kuyruğa eklendi.", "研究已加入队列。", "研究已加入佇列。", "研究がキューに追加されました。"
  ],
  [
    ...
    "Kullanılabilir veritabanı yok.", "没有可用的数据库。", "沒有可用的資料庫。", "利用可能なデータベースがありません。"
  ],
  [
    "Preparando preview…",
    "Preparing preview…",
    ...
    "Önizleme hazırlanıyor…", "正在准备预览…", "正在準備預覽…", "プレビューを準備しています…"
  ],
  ["Tokens", "Tokens", "Tokens", "Token", "Tokens", "Tokens", "Token", "Token", "词元", "詞元", "トークン"],
  [
    "Estimación",
    "Estimate",
    "Estimation",
  ...
  [
    ...
    "Título da seção {n}",
    "Titolo sezione {n}",
    "Bölüm başlığı {n}", "第 {n} 节标题", "第 {n} 節標題", "セクションのタイトル {n}"
  ],
  [
    "Foco de sección {n}",
    "Section focus {n}",
    ...
    "Foco da seção {n}",
    "Focus sezione {n}",
    "Bölüm odağı {n}", "第 {n} 节焦点", "第 {n} 節焦點", "セクションのフォーカス {n}"
  ],
  [
    ...
    "Bu seçim için satır yok.", "此选择没有行。", "此選擇沒有行。", "この選択には行がありません。"
  ],
  [
    ...
    "Önizlemeyi görmek için bir veritabanı seçin.", "选择一个数据库以查看预览。", "選擇一個數據庫以檢視預覽。", "データベースを選択してプレビューを表示します。"
  ],
  [
    ...
    "Veritabanı araştırması modeli", "用于数据库研究的模型", "用於資料庫研究的模型", "データベース研究用モデル"
  ],
  [
    "Encolando…",
    "Queueing…",
    ...
    "Enfileirando…",
    "Accodamento…",
    "Kuyruğa alınıyor…", "正在加入队列…", "正在加入佇列…", "キュー中…"
  ],
  [
    ...
    "Preparar o conjunto",
    "Prepara il set",
    "Kümeyi hazırla", "准备工作集", "準備工作集", "セットを準備する"
  ],
  [
    "Explorar patrones",
    "Explore patterns",
    ...
    "Explorar padrões",
    "Esplora i pattern",
    "Örüntüleri keşfet", "探索模式", "探索模式", "パターンを探索する"
  ],
  [
    ...
    "Kanıtları karşılaştır", "对照证据", "對照證據", "対照的な証拠"
  ],
  [
    ...
    "Redigir e verificar",
    "Redigi e verifica",
    "Yaz ve doğrula", "撰写并验证", "撰寫並驗證", "書いて検証する"
  ],
  [
    ...
    "Seçilen görünümleri ve filtreleri uygula.", "应用所选的视图和筛选。", "應用所選的檢視和篩選。", "選択したビューとフィルターを適用します。"
  ],
  [
    ...
    "İlişkileri ve anormallikleri bul.", "查找关系与异常。", "查詢關係與異常。", "関係性と異常性を見つけます。"
  ],
  [
    ...
    "Sinyali istisnadan ayır.", "将信号与例外分开。", "將訊號與例外分開。", "信号と例外を分離します。"
  ],
  [
    ...
    "Kanıtlarla sonuçlar sun.", "交付有证据支持的结论。", "交付有證據支援的結論。", "証拠を伴った結論を導き出します。"
  ],
  [
    ...
    "Kuyrukta henüz araştırma yok.", "队列中还没有研究。", "佇列中還沒有研究。", "キューにはまだ調査実行がありません。"
  ],
  [
    ...
    "Araştırma tamamlandığında sonuçlarınız burada görünür.", "研究完成后，结果会显示在这里。", "研究完成後，結果會顯示在這裡。", "研究が完了すると、結果がここに表示されます。"
  ],
  [
    ...
    "Bu raporda ayrıntılı kanıt yok.", "此报告没有详细证据。", "此報告沒有詳細證據。", "この報告書には詳細な証拠はありません。"
  ],
  [
    ...
    "Tablolarınızdaki örüntüleri ve karşıtlıkları izlenebilir kanıtlarla araştırın.", "用可追溯的证据研究你表格中的模式与对照。", "用可追溯的證據研究你表格中的模式與對照。", "追跡可能な証拠を使用して、テーブル内のパターンとコントラストを調査します。"
  ],
  [
    "Limpiar finalizados",
    "Clear finished",
    ...
    "Limpar concluídos",
    "Cancella terminati",
    "Tamamlananları temizle", "清除已完成", "清除已完成", "クリア済み"
  ],
  [
    "Enfocada",
    "Focused",
  ...
  [
    ...
    "Tek geçiş, kısa sentez", "单次遍历，紧凑综合", "單次遍歷，緊湊綜合", "ワンパス、コンパクトな合成"
  ],
  [
    ...
    "Önerilen kapsam ve karşılaştırma", "推荐的覆盖与对照", "推薦的覆蓋與對照", "推奨されるカバレッジとコントラスト"
  ],
  [
    ...
    "Daha fazla yineleme ve kanıt", "更多迭代与证据", "更多迭代與證據", "さらなる反復と証拠"
  ],
  [
    ...
    "Veri Deep Research API’si henüz kullanılamıyor.", "数据深度研究API尚不可用。", "資料深度研究API尚不可用。", "データ Deep Research API はまだ利用できません。"
  ],
  [
    ...
    "Tablolarınız hakkında bir soru sorun ve otomatik yapılandırmayla bir rapor oluşturun; gerekirse Gelişmiş seçeneklerden rolleri ve yapıyı ayarlayın.", "针对你的表格提出问题，并使用自动配置创建报告；如有需要，可在「高级选项」中调整角色和结构。", "針對你的表格提出問題，並使用自動配置建立報告；如有需要，可在「進階選項」中調整角色和結構。", "テーブルについて質問し、自動構成でレポートを作成します。必要に応じて、詳細オプションで役割と構造を調整します。"
  ],
  [
    ...
    "Yeniden üretilebilir sonuç", "可复现结果", "可復現結果", "再現可能な結果"
  ],
  [
    ...
    "Araştırmaya başlamadan önce bir model seçin.", "在开始研究前选择模型。", "在開始研究前選擇模型。", "研究を始める前にモデルを選択してください。"
  ],
  [
    ...
    "ZIP, seçilen satırların ham snapshot’ını içerecek. Devam edilsin mi?", "ZIP将包含所选行的原始快照。是否继续？", "ZIP將包含所選行的原始快照。是否繼續？", "ZIP には、選択した行の生のスナップショットが含まれます。続く？"
  ],
  [
    "Exportado: {path}",
    "Exported: {path}",
    ...
    "Exportado: {path}",
    "Esportato: {path}",
    "Dışa aktarıldı: {path}", "已导出：{path}", "已匯出：{path}", "エクスポート済み: {path}"
  ],
  [
    ...
    "{n} araştırma eski bir snapshot kullanıyor. Rapora güvenmeden önce kaynakları inceleyin.", "{n} 项研究使用了过期的快照。在采信报告前请核查来源。", "{n} 項研究使用了過期的快照。在採信報告前請核查來源。", "{n} 個の調査実行で古いスナップショットが使用されています。レポートを信頼する前に情報源を確認してください。"
  ],
  [
    ...
    "Planlayıcının sonuçları, tedavileri, zamanı ve karıştırıcıları ayırt etmesine yardımcı olur.", "帮助规划器区分结果、处理、时间与混杂因素。", "幫助規劃器區分結果、處理、時間與混雜因素。", "プランナーが結果、治療法、時間、交絡因子を区別できるように支援します。"
  ],
  [
    ...
    "Eski snapshot: bu sonucu yeniden kullanmadan önce kaynakları doğrulayın.", "快照已过期：在复用此结果前请核实来源。", "快照已過期：在複用此結果前請核實來源。", "古いスナップショット: この結果を再利用する前にソースを確認してください。"
  ],
  [
    ...
    "Snapshot’ı ZIP’e dahil et", "在ZIP中包含快照", "在ZIP中包含快照", "スナップショットを ZIP に含める"
  ],
  ["IC", "CI", "IC", "KI", "IC", "IC", "IC", "GA", "置信区间", "置信區間", "CI"],
  [
    "Resultado",
    "Outcome",
    "Résultat",
  ...
  [
    ...
    "Açıklamak veya tahmin etmek istediğiniz değişken.", "你想解释或估计的变量。", "你想解釋或估計的變數。", "説明または推定したい変数。"
  ],
  [
    "Tratamiento",
    "Treatment",
  ...
  [
    ...
    "Maruziyet, müdahale veya karşılaştırma grubu.", "暴露、干预或对照分组。", "暴露、干預或對照分組。", "暴露、介入、または比較グループ。"
  ],
  [
    "Confusores",
    "Confounders",
  ...
  [
    ...
    "Bir ilişkiyi açıklayabilecek değişkenler.", "可能解释关联的变量。", "可能解釋關聯的變數。", "関連性を説明できる変数。"
  ],
  ["Tiempo", "Time", "Temps", "Zeit", "Tempo", "Tempo", "Tempo", "Zaman", "时间", "時間", "時間"],
  [
    ...
    "Gözlemin tarihi veya anı.", "观测的日期或时刻。", "觀測的日期或時刻。", "観測の日付または瞬間。"
  ],
  [
    "Duración",
    "Duration",
  ...
  [
    ...
    "Sonuca veya olaya kadar geçen süre.", "到结果或事件发生的时间。", "到結果或事件發生的時間。", "結果またはイベントまでの時間。"
  ],
  [
    "Evento",
    "Event",
  ...
  [
    ...
    "Olayın gerçekleştiğini gösteren işaret.", "事件是否发生的指示变量。", "事件是否發生的指示變數。", "イベントが発生したことを示すインジケーター。"
  ],
  [
    "Entidad",
    "Entity",
  ...
  [
    ...
    "Gözlemlenen birim, kişi veya kayıt.", "所观测的单位、个人或记录。", "所觀測的單位、個人或記錄。", "観測された単位、人物、または記録。"
  ],
  ["Texto", "Text", "Texte", "Text", "Texto", "Texto", "Testo", "Metin", "文本", "文本", "文章"],
  [
    ...
    "Bağlam için metin sütunları.", "用于提供背景的文本列。", "用於提供背景的文本列。", "コンテキストのテキスト列。"
  ],
  [
    "Ubicación",
    "Location",
  ...
  [
    ...
    "İlişkili yer veya koordinat.", "关联的地点或坐标。", "關聯的地點或座標。", "関連する場所または座標。"
  ],
  [
    "Capturar snapshot",
    "Capture snapshot",
    ...
    "Capturar snapshot",
    "Acquisisci snapshot",
    "Snapshot al", "捕获快照", "捕獲快照", "スナップショットをキャプチャする"
  ],
  [
    "Perfilar semántica",
    "Profile semantics",
    ...
    "Anlamsal profil oluştur", "分析语义", "分析語義", "プロファイルのセマンティクス"
  ],
  [
    "Planificar análisis",
    "Plan analyses",
    ...
    "Analizleri planla", "规划分析", "規劃分析", "計画分析"
  ],
  [
    "Calcular resultados",
    "Calculate results",
    ...
    "Sonuçları hesapla", "计算结果", "計算結果", "結果の計算"
  ],
  [
    ...
    "Duyarlılığı kontrol et", "检查敏感性", "檢查敏感性", "感度をチェックする"
  ],
  [
    "Revisar objeciones",
    "Review objections",
    ...
    "İtirazları incele", "审查异议", "審查異議", "異議を検討する"
  ],
  [
    "Verificar evidencia",
    "Verify evidence",
    ...
    "Kanıtları doğrula", "验证证据", "驗證證據", "証拠を検証する"
  ],
  [
    "Ensamblar informe",
    "Assemble report",
    ...
    "Raporu oluştur", "组装报告", "組裝報告", "報告書をまとめる"
  ],
  [
    ...
    "Kullanılan satırları, görünümleri ve filtreleri sabitler.", "固定所用的行、视图和筛选。", "固定所用的行、檢視和篩選。", "使用される行、ビュー、フィルターを修正します。"
  ],
  [
    ...
    "Türleri, kapsamı ve eksik değerleri açıklar.", "描述类型、覆盖情况和缺失值。", "描述型別、覆蓋情況和缺失值。", "タイプ、カバレッジ、欠損値について説明します。"
  ],
  [
    ...
    "Hipotezleri, tahmin hedeflerini ve riskleri açıklar.", "明确假设、估计目标和风险。", "明確假設、估計目標和風險。", "仮説、推定値、リスクを明確にします。"
  ],
  [
    ...
    "Yeniden üretilebilir hesaplamaları çalıştırır.", "执行可复现的计算。", "執行可復現的計算。", "再現可能な計算を実行します。"
  ],
  [
    ...
    "Alternatif varsayımlar altındaki kararlılığı ölçer.", "衡量在替代假设下的稳定性。", "衡量在替代假設下的穩定性。", "別の仮定の下での安定性を測定します。"
  ],
  [
    ...
    "Karşı örnekleri ve rakip açıklamaları arar.", "寻找反例和竞争性解释。", "尋找反例和競爭性解釋。", "反例やライバルの説明を探します。"
  ],
  [
    ...
    "İddiaları kanıt defterleriyle karşılaştırır.", "将论断与其证据台账进行对照。", "將論斷與其證據臺賬進行對照。", "請求を証拠台帳と照合します。"
  ],
  [
    ...
    "Raporu ve sınırlılıklarını yazar.", "撰写报告及其局限性。", "撰寫報告及其侷限性。", "レポートとその制限事項を作成します。"
  ],
  [
    ...
    "Hassas roller tek bir veritabanına ait olmalıdır.", "敏感角色必须属于同一个数据库。", "敏感角色必須屬於同一個資料庫。", "機密ロールは1つのデータベースに属している必要があります。"
  ],
  [
    ...
    "{n} araştırma kısmen tamamlandı. Sonuçlarını kullanmadan önce sınırlamaları ve kanıtları inceleyin.", "{n} 项研究部分完成。在使用其结论前请查看局限性和证据。", "{n} 項研究部分完成。在使用其結論前請檢視侷限性和證據。", "{n} 個の研究実行が部分的に終了しました。結論を使用する前に、制限と証拠を確認してください。"
  ],
  [
    ...
    "Kısmi rapor: sınırlamalar veya doğrulanamayan yapılar içeriyor.", "部分报告：包含局限性或无法验证的产物。", "部分報告：包含侷限性或無法驗證的產物。", "部分レポート: 制限事項または検証できないアーティファクトが含まれています。"
  ],
  [
    "Parcial",
    "Partial",
  ...
  [
    ...
    "Relatório parcial",
    "Report parziale",
    "Kısmi rapor", "部分报告", "部分報告", "部分的なレポート"
  ],
  [
    ...
    "Filtrelenmiş küme; kimlikler gizlendi", "已筛选集合；ID已脱敏", "已篩選集合；ID已脫敏", "フィルタリングされたセット。 ID が編集されました"
  ],
  ["Tipo de informe", "Report type", "Type de rapport", "Berichtstyp", "Tipo de relatório", "Tipo de relatório", "Tipo di report", "Rapor türü", "报告类型", "報告型別", "レポートの種類"],
  ["Idioma del informe", "Report language", "Langue du rapport", "Berichtssprache", "Idioma do relatório", "Idioma do relatório", "Lingua del report", "Rapor dili", "报告语言", "報告語言", "レポート言語"],
  ["Filtrar por tipo", "Filter by type", "Filtrer par type", "Nach Typ filtern", "Filtrar por tipo", "Filtrar por tipo", "Filtra per tipo", "Türe göre filtrele", "按类型筛选", "按型別篩選", "タイプでフィルタリングする"],
  ["Todos los tipos", "All types", "Tous les types", "Alle Typen", "Todos os tipos", "Todos os tipos", "Tutti i tipi", "Tüm türler", "所有类型", "所有型別", "全種類"],
  ["Elige el enfoque; Nodus validará sus requisitos.", "Choose the focus; Nodus will validate its requirements.", "Choisissez l’approche ; Nodus validera ses exigences.", "Wähle den Fokus; Nodus prüft die Anforderungen.", "Escolha o foco; o Nodus validará os requisitos.", "Escolha o foco; o Nodus validará os requisitos.", "Scegli l’approccio; Nodus ne validerà i requisiti.", "Odağı seçin; Nodus gereksinimleri doğrular.", "选择侧重点；Nodus将验证其需求。", "選擇側重點；Nodus將驗證其需求。", "焦点を選択してください。 Nodus はその要件を検証します。"],
  ["Investigación general", "General research", "Recherche générale", "Allgemeine Recherche", "Investigação geral", "Pesquisa geral", "Ricerca generale", "Genel araştırma", "通用研究", "通用研究", "一般研究"],
  ["Panorama adaptativo de calidad, patrones y explicaciones.", "Adaptive overview of quality, patterns, and explanations.", "Vue adaptative de la qualité, des motifs et des explications.", "Adaptiver Überblick über Qualität, Muster und Erklärungen.", "Visão adaptativa de qualidade, padrões e explicações.", "Visão adaptativa de qualidade, padrões e explicações.", "Panoramica adattiva di qualità, pattern e spiegazioni.", "Kalite, örüntüler ve açıklamalar için uyarlanabilir genel bakış.", "质量、模式与解释的自适应概览。", "質量、模式與解釋的自適應概覽。", "品質、パターン、説明の適応的な概要。"],
  ["Calidad de datos", "Data quality", "Qualité des données", "Datenqualität", "Qualidade dos dados", "Qualidade dos dados", "Qualità dei dati", "Veri kalitesi", "数据质量", "資料質量", "データ品質"],
  ["Ausencias, duplicados, tipos, outliers e integridad.", "Missingness, duplicates, types, outliers, and integrity.", "Valeurs manquantes, doublons, types, valeurs aberrantes et intégrité.", "Fehlende Werte, Duplikate, Typen, Ausreißer und Integrität.", "Ausências, duplicados, tipos, outliers e integridade.", "Ausências, duplicados, tipos, outliers e integridade.", "Valori mancanti, duplicati, tipi, outlier e integrità.", "Eksikler, kopyalar, türler, aykırı değerler ve bütünlük.", "缺失、重复、类型、离群值与完整性。", "缺失、重複、型別、離群值與完整性。", "欠損、重複、タイプ、外れ値、および整合性。"],
  ["Comparación de cohortes", "Cohort comparison", "Comparaison de cohortes", "Kohortenvergleich", "Comparação de coortes", "Comparação de coortes", "Confronto tra coorti", "Kohort karşılaştırması", "队列比较", "佇列比較", "コホートの比較"],
  ["Contrasta grupos con efectos, intervalos y corrección FDR.", "Compare groups with effects, intervals, and FDR correction.", "Comparez les groupes avec effets, intervalles et correction FDR.", "Vergleiche Gruppen mit Effekten, Intervallen und FDR-Korrektur.", "Compare grupos com efeitos, intervalos e correção FDR.", "Compare grupos com efeitos, intervalos e correção FDR.", "Confronta gruppi con effetti, intervalli e correzione FDR.", "Grupları etkiler, aralıklar ve FDR düzeltmesiyle karşılaştırın.", "使用效应量、区间和FDR校正来比较各组。", "使用效應量、區間和FDR校正來比較各組。", "効果、間隔、FDR 補正を使用してグループを比較します。"],
  ["Anomalías temporales", "Temporal anomalies", "Anomalies temporelles", "Zeitliche Anomalien", "Anomalias temporais", "Anomalias temporais", "Anomalie temporali", "Zamansal anomaliler", "时间异常", "時間異常", "時間的異常"],
  ...
  ["Relaciones e integridad", "Relationships and integrity", "Relations et intégrité", "Beziehungen und Integrität", "Relações e integridade", "Relações e integridade", "Relazioni e integrità", "İlişkiler ve bütünlük", "关系与完整性", "關係與完整性", "人間関係と誠実さ"],
  ["Grafos, huérfanos, ciclos, cardinalidad y rollups.", "Graphs, orphans, cycles, cardinality, and rollups.", "Graphes, orphelins, cycles, cardinalité et agrégations.", "Graphen, verwaiste Datensätze, Zyklen, Kardinalität und Rollups.", "Grafos, órfãos, ciclos, cardinalidade e rollups.", "Grafos, órfãos, ciclos, cardinalidade e rollups.", "Grafi, orfani, cicli, cardinalità e rollup.", "Grafikler, yetimler, döngüler, kardinalite ve toplamalar.", "图、孤儿、环、基数与汇总。", "圖、孤兒、環、基數與彙總。", "グラフ、オーファン、サイクル、カーディナリティ、ロールアップ。"],
  ["Impacto causal", "Causal impact", "Impact causal", "Kausale Wirkung", "Impacto causal", "Impacto causal", "Impatto causale", "Nedensel etki", "因果影响", "因果影響", "因果関係"],
  ["Efectos bajo supuestos explícitos y análisis de sensibilidad.", "Effects under explicit assumptions and sensitivity analysis.", "Effets sous hypothèses explicites et analyse de sensibilité.", "Effekte unter expliziten Annahmen und Sensitivitätsanalyse.", "Efeitos sob pressupostos explícitos e análise de sensibilidade.", "Efeitos sob suposições explícitas e análise de sensibilidade.", "Effetti sotto ipotesi esplicite e analisi di sensibilità.", "Açık varsayımlar altında etkiler ve duyarlılık analizi.", "在明确假设下的效应及敏感性分析。", "在明確假設下的效應及敏感性分析。", "明示的な仮定と感度分析に基づく効果。"],
  ["Supervivencia y retención", "Survival and retention", "Survie et rétention", "Überleben und Bindung", "Sobrevivência e retenção", "Sobrevivência e retenção", "Sopravvivenza e retention", "Sağkalım ve elde tutma", "生存与留存", "生存與留存", "生存と保持"],
  ["Censura, Kaplan–Meier, log-rank y Cox.", "Censoring, Kaplan–Meier, log-rank, and Cox.", "Censure, Kaplan–Meier, log-rank et Cox.", "Zensierung, Kaplan–Meier, Log-Rank und Cox.", "Censura, Kaplan–Meier, log-rank e Cox.", "Censura, Kaplan–Meier, log-rank e Cox.", "Censura, Kaplan–Meier, log-rank e Cox.", "Sansür, Kaplan–Meier, log-rank ve Cox.", "删失、Kaplan–Meier、log-rank与Cox。", "刪失、Kaplan–Meier、log-rank與Cox。", "検閲、カプラン・マイヤー、ログランク、およびコックス。"],
  ["Privacidad y adjuntos", "Privacy and attachments", "Confidentialité et pièces jointes", "Datenschutz und Anhänge", "Privacidade e anexos", "Privacidade e anexos", "Privacy e allegati", "Gizlilik ve ekler", "隐私与附件", "隱私與附件", "プライバシーと添付ファイル"],
  ...
  ["Fórmulas y reconciliación", "Formulas and reconciliation", "Formules et rapprochement", "Formeln und Abstimmung", "Fórmulas e reconciliação", "Fórmulas e reconciliação", "Formule e riconciliazione", "Formüller ve mutabakat", "公式与对账", "公式與對賬", "公式と調整"],
  ...
  ["Buscar entre tus informes", "Search your reports", "Rechercher dans vos rapports", "Berichte durchsuchen", "Pesquisar nos seus relatórios", "Pesquisar nos seus relatórios", "Cerca nei tuoi report", "Raporlarınızda ara", "在你的报告中搜索", "在你的報告中搜索", "レポートを検索する"],
  ["Filtrar por lectura", "Filter by read status", "Filtrer par état de lecture", "Nach Lesestatus filtern", "Filtrar por estado de leitura", "Filtrar por status de leitura", "Filtra per stato di lettura", "Okunma durumuna göre filtrele", "按阅读状态筛选", "按閱讀狀態篩選", "読み取りステータスによるフィルタリング"],
  ["No leídos", "Unread", "Non lus", "Ungelesen", "Não lidos", "Não lidos", "Non letti", "Okunmamış", "未读", "未讀", "未読"],
  ["Leídos", "Read", "Lus", "Gelesen", "Lidos", "Lidos", "Letti", "Okunmuş", "已读", "已讀", "読む"],
  ["No leído", "Unread", "Non lu", "Ungelesen", "Não lido", "Não lido", "Non letto", "Okunmamış", "未读", "未讀", "未読"],
  ["Marcar leído", "Mark as read", "Marquer comme lu", "Als gelesen markieren", "Marcar como lido", "Marcar como lido", "Segna come letto", "Okundu olarak işaretle", "标记为已读", "標記為已讀", "既読としてマークする"],
  ["Ningún informe coincide con los filtros.", "No reports match the filters.", "Aucun rapport ne correspond aux filtres.", "Keine Berichte entsprechen den Filtern.", "Nenhum relatório corresponde aos filtros.", "Nenhum relatório corresponde aos filtros.", "Nessun report corrisponde ai filtri.", "Filtrelerle eşleşen rapor yok.", "没有报告符合筛选条件。", "沒有報告符合篩選條件。", "フィルターに一致するレポートはありません。"],
