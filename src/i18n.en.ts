...
export const EN: Record<string, string> = {
  ...
  'Aun no hay proyectos. Crea uno para vincular notas, materiales y capitulos.': 'No projects yet. Create one to link notes, materials and chapters.',
  'Aun no hay versiones guardadas.': 'No saved versions yet.',
  'Brief, objetivo o pregunta principal': 'Brief, objective or main question',
  'Cambia a Insertar en borrador para aplicar automaticamente.': 'Switch to Insert into draft to apply automatically.',
  'Capitulo exportado:': 'Chapter exported:',
  'Capitulo guardado con version previa recuperable.': 'Chapter saved with a recoverable previous version.',
  'Capitulo importado y guardado como nota vinculada.': 'Chapter imported and saved as a linked note.',
  'Capitulos': 'Chapters',
  'Caps.': 'Chs.',
  'Crear proyecto': 'Create project',
  'Editable. Cada guardado crea version previa.': 'Editable. Each save creates a previous version.',
  'Exportar capitulo actual': 'Export current chapter',
  ...
  'No hay capitulo seleccionado.': 'No chapter selected.',
  ...
  'Sube un capitulo para empezar a trabajar sobre el manuscrito.': 'Upload a chapter to start working on the manuscript.',
  'Subir capitulo': 'Upload chapter',
  'Sugerencias aplicadas sobre una version nueva del borrador.': 'Suggestions applied to a new version of the draft.',
  ...
  'Sugerir ubicacion': 'Suggest location',
  'Titulo': 'Title',
  'Version restaurada. Se guardo una copia previa antes de restaurar.': 'Version restored. A previous copy was saved before restoring.',
  'Versiones': 'Versions',
  'Resumen (orientación):': 'Summary (orientation):',
  ...
  'Capitulo del proyecto': 'Project chapter',
