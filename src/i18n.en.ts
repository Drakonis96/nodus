...
export const EN: Record<string, string> = {
  ...
  'Copias cifradas periódicas en una carpeta a tu elección (apúntala a iCloud Drive o Google Drive para tenerlas fuera de este equipo). No incluyen claves API.':
    'Periodic encrypted copies into a folder of your choice (point it at iCloud Drive or Google Drive to keep them off this machine). API keys are never included.',
  ...
  'Tres tablas de investigación (muestras, experimentos y lecturas) con columnas de todo tipo, opciones de color y decenas de registros. Incluye un tutorial guiado.':
    'Three research tables (samples, experiments and reading list) with columns of every type, colour-coded options and dozens of records. Includes a guided tutorial.',
