...
Nodus 4.2.3 is licensed exclusively under the GNU Affero General Public
...
The preferred form for modifying the official Nodus 4.2.3 release is available
from the immutable release tag and its source archives:

- Tag and release: https://github.com/Drakonis96/nodus/releases/tag/v4.2.3
- Source tree: https://github.com/Drakonis96/nodus/tree/v4.2.3
- Tar archive: https://github.com/Drakonis96/nodus/archive/refs/tags/v4.2.3.tar.gz
- ZIP archive: https://github.com/Drakonis96/nodus/archive/refs/tags/v4.2.3.zip
