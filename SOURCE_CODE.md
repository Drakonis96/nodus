...
Nodus 4.0.1 is licensed exclusively under the GNU Affero General Public
...
The preferred form for modifying the official Nodus 4.0.1 release is available
from the immutable release tag and its source archives:

- Tag and release: https://github.com/Drakonis96/nodus/releases/tag/v4.0.1
- Source tree: https://github.com/Drakonis96/nodus/tree/v4.0.1
- Tar archive: https://github.com/Drakonis96/nodus/archive/refs/tags/v4.0.1.tar.gz
- ZIP archive: https://github.com/Drakonis96/nodus/archive/refs/tags/v4.0.1.zip
