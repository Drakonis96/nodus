...
Nodus 5.4.2 is licensed exclusively under the GNU Affero General Public
...
The preferred form for modifying the official Nodus 5.4.2 release is available
from the immutable release tag and its source archives:

- Tag and release: https://github.com/Drakonis96/nodus/releases/tag/v5.4.2
- Source tree: https://github.com/Drakonis96/nodus/tree/v5.4.2
- Tar archive: https://github.com/Drakonis96/nodus/archive/refs/tags/v5.4.2.tar.gz
- ZIP archive: https://github.com/Drakonis96/nodus/archive/refs/tags/v5.4.2.zip
