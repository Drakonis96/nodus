...
export function createAIRoutes({
  ...
  // Portable profile preferences are part of the shared Server/Desktop
  // boundary, including basic deployments where Server AI is intentionally
  ...
  return { handle, handleProfilePreferences, providerMetadata };
}
