...
export const SERVER_LANGUAGES = ['en', 'es', 'fr', 'de', 'pt', 'pt-BR', 'it', 'tr', 'zh-CN', 'zh-TW', 'ja', 'ko'];
...
const KO = {
  ...
  createReader: 'Create reader account',
  spaces: 'Spaces',
  lastPublication: '마지막 출판',
  noSpaces: 'There are no spaces yet.',
  usersAccess: '사용자 및 액세스',
  mcpReadOnly: 'The current version provides read-only MCP tools. It does not expose grades or remote writing.',
  account: 'Account',
  access: '입장',
  actions: '행위',
  publisherDevices: '게시자 기기',
  device: '장치',
  lastUsed: '마지막으로 사용됨',
  noDevices: 'There are no paired devices.',
  never: '절대',
  ...
  administrator: 'Administrator',
  memberAccount: 'User',
  vaultTypeAcademic: '학생',
  vaultTypePrimarySources: '1차 소스',
  vaultTypeGenealogy: '가계',
  vaultTypeDatabases: '데이터베이스',
  vaultTypeStudy: '공부하다',
  vaultTypeTeaching: '가르침',
  vaultTypeTestimonies: '증언',
  vaultTypeProsopography: '프로소그래피',
  vaultTypeWorldbuilding: '세계 건설',
  unlockEmails: 'Reveal and edit email addresses',
  unlockEmailsHelp: 'For privacy, addresses are hidden until you confirm your administrator password.',
  unlockForFiveMinutes: 'Unlock for 5 minutes',
  emailAccessUnlocked: 'Email addresses are visible in this session for five minutes.',
