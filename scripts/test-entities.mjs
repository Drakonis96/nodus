...
try {
  ...
  repo.setPersonPortrait(juan.personId, portraitPng, 'image/png', { focusX: 0.4, focusY: 0.3, scale: 1.5 });
  ...
  assert.ok(repo.getPersonPortrait(juan.personId).blob.equals(portraitPng), 'original blob fetched on demand');
  ...
  repo.setPersonPortrait(juan.personId, portraitPng, 'image/png', { focusX: 0.5, focusY: 0.42, scale: 1 }, true);
