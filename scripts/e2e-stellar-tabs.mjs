...
try {
 ...
 await page.evaluate(async()=>{
  sessionStorage.setItem('nodus.startupUpdateChecked','1');localStorage.setItem('nodus.lastSeenVersion','5.2.0');localStorage.setItem('nodus.mobileTeaserSeen.5.2.0','1');
