...
try {
 ...
 await page.evaluate(async()=>{
  sessionStorage.setItem('nodus.startupUpdateChecked','1');localStorage.setItem('nodus.lastSeenVersion','5.3.1');localStorage.setItem('nodus.mobileTeaserSeen.5.3.1','1');
