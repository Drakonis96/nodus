...
test('all first-party release metadata identifies 4.0.0 as AGPL-3.0-only', async () => {
  ...
  assert.match(citation, /^version: "4\.0\.0"$/m);
...
test('desktop, server, container and Zotero package expose corresponding source', async () => {
  ...
  assert.match(sourceOffer, /releases\/tag\/v4\.0\.0/);
});
