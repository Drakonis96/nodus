...
try {
  ...
  const currentMajorNotes = releaseNotesForMajor('2.3.6');

  assert.equal(currentMajorNotes[0]?.version, '2.3.6');
  ...
  assert.ok(!releaseNotesForMajor('2.3.5').some((note) => note.version === '2.3.6'));
