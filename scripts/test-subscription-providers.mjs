...
test('redistributed official runtimes retain the required license notices', () => {
  ...
  const copilotCliLicensePath = path.join(repoRoot, 'node_modules/@github/copilot/LICENSE.md');
  const copilotCliLicense = fs.existsSync(copilotCliLicensePath) ? fs.readFileSync(copilotCliLicensePath, 'utf8') : null;
