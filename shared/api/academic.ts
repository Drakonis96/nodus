...
} from "../studyAcademicYears"; // Declared in shared/types.ts itself; the resulting cycle is types-only and erased at build time.
import type {
  AddProjectLinkInput,
...
export interface AcademicApi {
  ...
  listDictionaryEvidence(
    request: DictionaryEvidenceRequest,
  ): Promise<DictionaryEvidencePage>;
  setDictionaryEvidenceDecision(
    entryId: string,
  ...
  startDictionaryGeneration(
    request: DictionaryGenerationRequest,
  ): Promise<DictionaryProgress>;
  onDictionaryProgress(
    callback: (progress: DictionaryProgress) => void,
  ): () => void;
  listDictionaryVersions(entryId: string): Promise<DictionaryVersion[]>;
  acceptDictionaryVersion(
    entryId: string,
    versionId: string,
  ...
  openEvidenceAtPage(
    ...
    ok: boolean;
    mode: "pdf-page" | "select" | "none";
    page?: number | null;
  }>;
  /** Clean Markdown reader stored under the configured backup root. */
  getLibraryReaderDocument(
    nodusId: string,
  ): Promise<LibraryReaderDocument | null>;
  getLibraryReaderAttachmentContent(
    nodusId: string,
    attachmentId: string,
  ): Promise<LibraryReaderAttachmentContent | null>;
  openLibraryReaderOriginal(nodusId: string): Promise<boolean>;
  listLibraryReaderAnnotations(
    nodusId: string,
  ): Promise<WritingDraftAnnotation[]>;
  listLibraryReaderOrphanedAnnotations(
    nodusId: string,
  ): Promise<WritingDraftAnnotation[]>;
  createLibraryReaderAnnotation(
    nodusId: string,
    input: WritingDraftAnnotationInput,
  ): Promise<WritingDraftAnnotation>;
  updateLibraryReaderComment(
    nodusId: string,
    id: string,
    comment: string,
  ): Promise<WritingDraftAnnotation | null>;
  deleteLibraryReaderAnnotation(nodusId: string, id: string): Promise<void>;
  onLibraryReaderAnnotationsChanged(
    cb: (nodusId: string | null) => void,
  ): () => void;
  listLibraryReaderChatMessages(
    nodusId: string,
  ): Promise<LibraryReaderChatMessage[]>;
  libraryReaderChatStream(
    request: LibraryReaderChatRequest,
    handlers: LibraryReaderChatStreamHandlers,
  ...
  onStudyMaterialAiProcessingRequest(
    cb: (request: StudyMaterialAiProcessingPrompt) => void,
  ): () => void;
  ...
  createStudyAcademicYear(
    input: CreateStudyAcademicYearInput,
  ): Promise<StudyAcademicYear>;
  updateStudyAcademicYear(
    id: string,
    patch: UpdateStudyAcademicYearInput,
  ): Promise<StudyAcademicYear | null>;
  ...
  updateStudyEntity(
    ...
    StudyCourse | StudySubject | StudyTopic | StudyFolder | StudyDocument | null
  >;
  moveStudyEntity(
    kind: Exclude<StudyEntityKind, "course" | "document">,
    id: string,
    input: StudyEntityMoveInput,
  ): Promise<StudySubject | StudyTopic | StudyFolder>;
  addStudyPlacement(
    documentId: string,
    input: StudyPlacementInput,
  ): Promise<StudyPlacement>;
  setPrimaryStudyPlacement(
    documentId: string,
    input: StudyPlacementInput,
  ): Promise<StudyPlacement>;
  ...
  duplicateStudyTree(
    ...
    StudyCourse | StudySubject | StudyTopic | StudyFolder | StudyDocument
  >;
  ...
  ): Promise<StudyTemplate | null>;
  deleteStudyTemplate(id: string): Promise<void>;
  applyStudyTemplate(
    id: string,
    name?: string,
  ): Promise<StudyCourse | StudySubject | StudyDocument>;
  getStudyDocEditorData(documentId: string): Promise<StudyDocEditorData>;
  updateStudyDoc(
    documentId: string,
    input: StudyDocUpdateInput,
  ): Promise<StudyDocument>;
  restoreStudyDocVersion(
    documentId: string,
    versionId: string,
  ): Promise<StudyDocument>;
  ...
  transcribeStudyAudio(
    ...
    handlers?: StudySttStreamHandlers,
  ...
  restoreStudyStyleVersion(
    styleId: string,
    versionId: string,
  ): Promise<StudyStyle>;
  listStudyStyleAssociations(): Promise<StudyStyleAssociation[]>;
  setStudyStyleAssociation(
    styleId: string,
    kind: StudyStyleAssociationKind,
    targetId?: string,
    isDefault?: boolean,
  ): Promise<StudyStyleAssociation>;
  resolveStudyStyleDefault(
  ...
  improveStudyText(
    ...
    handlers: StudyImproveStreamHandlers,
  ): Promise<StudyImproveResult>;
  suggestStudySynonyms(
  ...
  updateStudyImprovementAction(
    id: string,
    action: StudyImprovementLog["action"],
  ): Promise<void>;
  listStudyMaterials(
    options?: StudyMaterialListOptions,
  ...
  importStudyMaterials(
    input?: StudyMaterialImportInput,
  ): Promise<StudyMaterialImportResult[]>;
  importStudyMaterialFolder(
    input?: StudyMaterialImportInput,
  ): Promise<StudyMaterialImportResult[]>;
  chooseStudyMaterialPaths(folder?: boolean): Promise<string[]>;
  importStudyMaterialPaths(
    paths: string[],
    input?: StudyMaterialImportInput,
  ): Promise<StudyMaterialImportResult[]>;
  importZoteroStudyMaterial(
    input: ZoteroStudyMaterialImportInput,
  ): Promise<StudyMaterialImportResult>;
  ...
  replaceStudyMaterialFile(
    id: string,
    ocr?: boolean,
  ): Promise<StudyMaterialSummary | null>;
  updateStudyMaterial(
    id: string,
    patch: StudyMaterialUpdateInput,
  ): Promise<StudyMaterialSummary>;
  restoreStudyMaterialVersion(
    id: string,
    versionId: string,
  ): Promise<StudyMaterialSummary>;
  addStudyMaterialPlacement(
    id: string,
    input: StudyMaterialImportInput,
  ): Promise<StudyMaterialPlacement | null>;
  setPrimaryStudyMaterialPlacement(
    id: string,
    input: StudyMaterialImportInput,
  ): Promise<StudyMaterialPlacement | null>;
  removeStudyMaterialPlacement(id: string, placementId: string): Promise<void>;
  createStudyMaterialAnnotation(
    materialId: string,
    input: StudyMaterialAnnotationInput,
  ): Promise<StudyMaterialAnnotation>;
  updateStudyMaterialAnnotation(
    id: string,
    patch: Partial<StudyMaterialAnnotationInput>,
  ): Promise<StudyMaterialAnnotation>;
  deleteStudyMaterialAnnotation(id: string): Promise<void>;
  exportAnnotatedStudyMaterial(id: string): Promise<{ path: string } | null>;
  createStudyNoteFromMaterial(
    materialId: string,
    annotationId?: string | null,
    title?: string,
  ): Promise<{ documentId: string }>;
  setStudyMaterialLifecycle(
    id: string,
    action: "archive" | "restore" | "trash" | "recover" | "delete",
    options?: { purgeLinkedKnowledge?: boolean },
  ): Promise<void>;
  listStudyRecordings(
    options?: StudyRecordingListOptions,
  ): Promise<StudyRecordingSummary[]>;
  getStudyRecording(id: string): Promise<StudyRecordingDetail>;
  getStudyRecordingContent(id: string): Promise<StudyRecordingContent>;
  createStudyRecording(
    input: StudyRecordingCreateInput,
  ): Promise<StudyRecordingImportResult>;
  importStudyRecordings(
    scope?: Omit<StudyRecordingCreateInput, "bytes" | "fileName" | "mimeType">,
  ): Promise<StudyRecordingImportResult[]>;
  updateStudyRecording(
    id: string,
    patch: StudyRecordingUpdateInput,
  ): Promise<StudyRecordingSummary>;
  createStudyAudioMarker(
    recordingId: string,
    input: StudyAudioMarkerInput,
  ): Promise<StudyAudioMarker>;
  updateStudyAudioMarker(
    id: string,
    patch: Partial<StudyAudioMarkerInput>,
  ): Promise<StudyAudioMarker>;
  deleteStudyAudioMarker(id: string): Promise<void>;
  saveStudyTranscript(
    recordingId: string,
    input: StudyTranscriptInput,
  ): Promise<StudyTranscript>;
  updateStudyTranscript(
    id: string,
    contentMarkdown: string,
    segments?: StudyTranscriptSegmentInput[],
  ): Promise<StudyTranscript>;
  diarizeStudyRecording(
    request: StudyDiarizationRequest,
  ): Promise<StudyDiarizationResult>;
  updateStudyTranscriptSegment(
    id: string,
    patch: Partial<StudyTranscriptSegmentInput>,
  ): Promise<StudyTranscriptSegment>;
  deleteStudyTranscript(id: string): Promise<void>;
  createStudyNoteFromTranscript(
    recordingId: string,
    transcriptId: string,
    placements?: StudyPlacementInput[],
  ): Promise<{ documentId: string }>;
  deleteStudyRecordingAudio(id: string): Promise<StudyRecordingSummary>;
  setStudyRecordingLifecycle(
    id: string,
    action: "archive" | "restore" | "trash" | "recover" | "delete",
  ): Promise<void>;
  searchStudyCorpus(
  ...
  setStudySearchSourceExcluded(
    sourceId: string,
    excluded: boolean,
  ): Promise<StudySearchIndexStatus>;
  listStudySavedSearches(): Promise<StudySavedSearch[]>;
  saveStudySearch(
    name: string,
    query: string,
    options: StudySearchOptions,
  ): Promise<StudySavedSearch>;
  ...
  onStudySearchProgress(
    cb: (progress: StudySearchProgress) => void,
  ): () => void;
  listStudyIdeas(
    subjectId: string,
    query?: string,
  ): Promise<StudyIdeaSummary[]>;
  ...
  onStudyKnowledgeChanged(
    cb: (progress: StudyKnowledgeProgress) => void,
  ): () => void;
  listStudyAssistantSources(): Promise<StudyAssistantSourceOption[]>;
  listStudyAssistantConversations(
    includeArchived?: boolean,
  ): Promise<StudyAssistantConversationSummary[]>;
  getStudyAssistantConversation(
    id: string,
  ): Promise<StudyAssistantConversation | null>;
  createStudyAssistantConversation(
    input?: StudyAssistantConversationInput,
  ): Promise<StudyAssistantConversation>;
  updateStudyAssistantConversation(
    id: string,
    patch: StudyAssistantConversationPatch,
  ): Promise<StudyAssistantConversation | null>;
  deleteStudyAssistantConversation(id: string): Promise<void>;
  streamStudyAssistant(
    request: StudyAssistantRequest,
    handlers: StudyAssistantStreamHandlers,
  ): Promise<StudyAssistantResponse>;
  cancelStudyAssistant(): Promise<void>;
  exportStudyAssistantConversation(
    id: string,
  ): Promise<{ path: string } | null>;
  ...
  updateStudyQuestion(
    id: string,
    patch: Partial<StudyQuestionInput>,
  ...
  restoreStudyQuestionVersion(
    id: string,
    versionId: string,
  ): Promise<StudyQuestion>;
  setStudyQuestionLifecycle(
    id: string,
    action: "archive" | "restore" | "trash" | "recover" | "delete",
  ): Promise<void>;
  generateStudyQuestions(
    request: StudyQuestionGenerationRequest,
  ): Promise<StudyQuestionGenerationResult>;
  ...
  createStudyQuestionCollection(
    name: string,
    description?: string,
  ): Promise<StudyQuestionCollection>;
  setStudyQuestionCollectionItems(
    collectionId: string,
    questionIds: string[],
  ): Promise<void>;
  deleteStudyQuestionCollection(id: string): Promise<void>;
  getStudyQuestionAnalytics(id: string): Promise<StudyQuestionAnalytics>;
  findSimilarStudyQuestions(
    id: string,
    threshold?: number,
  ): Promise<StudyQuestionSimilar[]>;
  listStudyAssessments(
    kind?: StudyAssessment["kind"],
    includeArchived?: boolean,
  ...
  updateStudyFlashcard(
    id: string,
    patch: Partial<StudyFlashcardInput>,
  ): Promise<StudyFlashcard>;
  createStudyFlashcardsFromQuestions(
    questionIds: string[],
  ): Promise<StudyFlashcard[]>;
  reviewStudyFlashcard(
    input: StudyReviewInput,
  ): Promise<{ card: StudyFlashcard; review: StudyReviewRecord }>;
  setStudyFlashcardState(
    id: string,
    action: "master" | "reset" | "exclude" | "include" | "archive" | "delete",
  ): Promise<void>;
  ...
  createStudyCalendarEvent(
    input: StudyCalendarEventInput,
  ): Promise<StudyCalendarEvent>;
  updateStudyCalendarEvent(
    id: string,
    input: StudyCalendarEventInput,
  ): Promise<StudyCalendarEvent>;
  deleteStudyCalendarEvent(id: string): Promise<void>;
  addStudyCalendarEventToExternal(
    id: string,
    target: "google" | "icloud",
  ): Promise<void>;
  ...
  updateStudyPlannerItem(
    kind: "block" | "event" | "goal",
    id: string,
    patch: Record<string, unknown>,
  ): Promise<void>;
  ...
  }): Promise<StudyStudySession>;
  finishStudySession(
    id: string,
    input: { actualSeconds: number; interruptions?: number; notes?: string },
  ): Promise<StudyStudySession>;
  ...
  generateImmersionSession(
    ...
    handlers?: ImmersionStreamHandlers,
  ...
  answerImmersionQuestion(
    request: ImmersionAnswerRequest,
  ): Promise<ImmersionAnswerResult>;
  ...
  analyzeDebate(
    ...
    handlers: DebateAnalysisStreamHandlers,
  ...
  // writing workshop
  getWritingWorkshopSnapshot(
    brief: WritingWorkshopBrief,
  ): Promise<WritingWorkshopSnapshot>;
  generateWritingWorkshopDraft(
    request: WritingWorkshopDraftRequest,
  ): Promise<WritingWorkshopDraft>;
  ...
  saveWritingWorkshopDraft(
    request: WritingWorkshopSaveDraftRequest,
  ): Promise<WritingWorkshopSavedDraft>;
  /**
   ...
   */
  setWritingWorkshopDraftRead(
    id: string,
    read: boolean,
  ): Promise<WritingWorkshopSavedDraft | null>;
  ...
  listWritingDraftAnnotations(
    draftId: string,
  ): Promise<WritingDraftAnnotation[]>;
  createWritingDraftAnnotation(
    input: WritingDraftAnnotationInput,
  ): Promise<WritingDraftAnnotation>;
  updateWritingDraftComment(
    id: string,
    comment: string,
  ): Promise<WritingDraftAnnotation | null>;
  ...
  onWritingDraftAnnotationsChanged(
    cb: (draftId: string | null) => void,
  ): () => void;
  ...
  tutorStepStream(
    ...
    handlers: TutorStepStreamHandlers,
  ...
  createManualIdea(input: {
    folderId: string | null;
    title?: string;
  }): Promise<{ note: Note; globalId: string }>;
  ...
  listWorkspaceLibraryLinks(
    ownerKind: WorkspaceLinkOwnerKind,
    ownerId: string,
  ): Promise<WorkspaceLibraryLink[]>;
  listAllWorkspaceLibraryLinks(): Promise<WorkspaceLibraryLink[]>;
  addWorkspaceLibraryLink(
    input: WorkspaceLibraryLinkInput,
  ): Promise<WorkspaceLibraryLink>;
  ...
  importProjectChapter(
    input: ImportProjectChapterInput,
  ): Promise<ProjectChapter | null>;
  ...
  ): Promise<ProjectInsertionSuggestion | null>;
  applyProjectSuggestions(
    request: ApplyProjectSuggestionsRequest,
  ): Promise<ProjectChapter | null>;
  listProjectChapterVersions(
    chapterId: string,
  ): Promise<ProjectChapterVersion[]>;
  restoreProjectChapterVersion(
    versionId: string,
  ): Promise<ProjectChapter | null>;
  ...
  onChapterRelationsProgress(
    cb: (p: ChapterRelationsProgress) => void,
  ): () => void;
  ...
  applyManuscriptCitation(
    request: ApplyManuscriptCitationRequest,
  ): Promise<ApplyManuscriptCitationResult>;
  exportProject(
    request: ExportProjectRequest,
  ): Promise<{ path: string } | null>;
  exportProjectChapter(
  ...
  ): Promise<StudyDataMaintenanceResult>;
  exportStudyDiagnostic(): Promise<{ path: string } | null>;
  exportStudyScope(
    scope: StudyExportScope,
  ...
  seedGenealogyDemoData(): Promise<{
    seeded: boolean;
    willGeneratePortraits: boolean;
  }>;
