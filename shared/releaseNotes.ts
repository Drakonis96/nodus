...
const RELEASE_2_8_0_HIGHLIGHTS: RawReleaseHighlight[] = [
  ...
  {
    scope: 'testimonios',
    es: 'Transcripción local y exportación archivística. Whisper corre en tu equipo y el audio no sale de aquí; la atribución de hablantes es manual y en lote, porque Nodus no reconoce voces ni va a fingir que sí. Al terminar puedes exportar tres paquetes distintos —preservación, consulta y revisión—, cada uno con su manifiesto, sus sumas de comprobación SHA-256 y la lista explícita de qué quedó fuera y por qué. La demo «Memoria del valle» enseña el recorrido completo con audio sintético y ninguna voz real.',
    en: 'Local transcription and archival export. Whisper runs on your machine and the audio does not leave it; speaker attribution is manual and done in bulk, because Nodus does not recognise voices and will not pretend otherwise. When you finish you can export three different packages — preservation, access and review — each with its manifest, its SHA-256 checksums and an explicit list of what was left out and why. The “Valley Memory” demo walks the whole path with synthetic audio and no real voice.',
