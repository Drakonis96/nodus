...
- PDF Presenter ya se puede abrir: importa archivos PDF a una biblioteca global de Herramientas (con carpetas, búsqueda, orden y miniaturas), escribe notas del orador por diapositiva, impórtalas de un PowerPoint o expórtalas e impórtalas juntas en TXT, y añade vídeos de YouTube por diapositiva. Al presentar abre la diapositiva a pantalla completa (en la pantalla externa si hay dos) y una vista del presentador con la diapositiva actual, la siguiente, las notas, un temporizador y el reloj; incluye herramientas de anotación en directo (linterna, dibujo, puntero y lupa), pantalla en negro, y control remoto desde el móvil escaneando un código QR protegido por PIN. El único elemento que necesita conexión son los vídeos de YouTube; el resto funciona sin internet.
