...
For explicitly requested amide resonance use kind "mechanism", depiction "skeletal", rule "amide-resonance", and one species identifying a small acyclic N,N-dimethylamide. The code constructs charge-separated contributors and electron-flow arrows; these are resonance contributors, not reaction intermediates or an equilibrium.
