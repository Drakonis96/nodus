...
export interface StudyCalendarEvent { id: string; shortId: string; title: string; type: StudyCalendarEventType; startsAt: string; endsAt: string | null; allDay: boolean; courseId: string | null; subjectId: string | null; topicId: string | null; notes: string; reminderMinutes: number | null; completed: boolean; createdAt: string; updatedAt: string }
